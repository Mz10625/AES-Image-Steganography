...
class MainWindow(tk.Frame):
    def __init__(self, master=None):
        ...
        self.info1=tk.Label(master=None,text="Encoding of data within Image file.",bg="gray35",fg="white",font=('Aparajita',20))
        self.info1.place(relx=0.35,rely=0.25)
        self.info4=tk.Label(master=None,text="Data secured using AES-128 bit encryption before encoding",bg="gray35",fg="white",font=('Aparajita',20))
        self.info4.place(relx=0.25,rely=0.32)
        self.info2=tk.Label(master=None,text=" Image file format required for Encoding - .jpeg",bg="gray35",fg="white",font=('Aparajita',20))
        self.info2.place(relx=0.3,rely=0.39)
        self.info6=tk.Label(master=None,text=" Maximum text file size recommended - 100KB",bg="gray35",fg="white",font=('Aparajita',20))
        self.info6.place(relx=0.3,rely=0.46)
        self.info3=tk.Label(master=None,text=" Amount of data that can be encoded is based on image resolution.",justify="center",bg="gray35",fg="white",font=('Aparajita',20))
        self.info3.place(relx=0.22,rely=0.53)
        ...
        self.encodeb.place(relx=0.3,rely=0.7)        
        ...
        self.decodeb.place(relx=0.62,rely=0.7)
...
root.title("AES Image Steganography")
